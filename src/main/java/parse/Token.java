...
public class Token {
	 ...
	 * @param lineNum
	 *            The line number in the input file containing this token, or {code
	 *            -1} for an error token. Checks {@code lineNum > 0} or
	 *            {@code lineNum == -1}.
	 */
	public Token(TokenType t, int lineNum) {
	...
	static class NumToken extends Token {
		 ...
		 * @param lineNum
		 *            The line number in the input file containing this token. Checks
